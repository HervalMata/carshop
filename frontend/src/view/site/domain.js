    ...
    return (
        <>
            ...
            <div className="card-body scroll">
                <h6 className="text-center mb-4 mt-4">Vamos escolher um endereço para seu site</h6>
                    ...
                    <>
                        <div className="form-group">
                            <Typography className="text-center mt-4 mb-4" component="p">
                                ...
                                Para registrar um domínio acesse <Button color="primary" onClick={() => window.open('https://registro.br', '_blank')}>https://registro.br</Button>
                            </Typography>
